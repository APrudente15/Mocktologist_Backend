...
INSERT INTO drink ( user_id, name, response_body, tastes, done, vegan, rating, image) VALUES (1, 'Sparkling Citrus Splash', 'Mix freshly squeezed orange juice, lemon juice, and a splash of sparkling water. Garnish with a slice of orange and a sprig of mint. Serve over ice.', 'Sweet', true, true, 9, 'https://images.app.goo.gl/vXpvBnDdTBa2gBhG9');
INSERT INTO drink ( user_id, name, response_body, tastes, done, vegan, rating, image) VALUES (2, 'Berry Bliss Cooler', 'Muddle fresh strawberries and blueberries with a hint of agave syrup. Add freshly squeezed lime juice and coconut water. Shake well and strain into a glass filled with ice. Garnish with a skewer of mixed berries.', 'Sweet', true, true, 8, 'https://images.app.goo.gl/bnfYFHqBYgaWDC4YA');
INSERT INTO drink ( user_id, name, response_body, tastes, done, vegan, rating, image) VALUES (3, 'Sour Cherry Bomb', 'Muddle fresh cherries with lime juice and a hint of maple syrup. Shake with ice and strain into a glass. Top with a splash of club soda and garnish with a cherry skewer.', 'Sour', true, true, 6, 'https://images.app.goo.gl/SsijcU37AjT1y8vt7');
INSERT INTO drink ( user_id, name, response_body, tastes, done, vegan, rating, image) VALUES (4, 'Mocha Cream Dream', 'Brew a strong cup of espresso or very dark coffee. Allow it to cool. In a shaker, combine the cooled coffee with chocolate syrup, a splash of heavy cream, and a dash of vanilla extract. Shake well with ice and strain into a glass filled with ice cubes. Top with whipped cream and drizzle with additional chocolate syrup.', 'Coffee', true, false, 9, 'https://images.app.goo.gl/moAwtu6qqqTsK2Aq7');
INSERT INTO drink ( user_id, name, response_body, tastes, done, vegan, rating, image) VALUES (5, 'Caramel Espresso Delight', 'Brew a shot of espresso or very strong coffee. Allow it to cool. In a glass, mix the cooled espresso with caramel syrup and a splash of half-and-half cream. Stir well. Add ice cubes if desired. Garnish with whipped cream and a drizzle of caramel sauce.', 'Coffee', false, false, 8, 'https://images.app.goo.gl/A3FMCYPXRrh76t9p9');
